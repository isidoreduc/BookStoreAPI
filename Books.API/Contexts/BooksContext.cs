...
namespace Books.API.Contexts
{
    public class BooksContext : DbContext
    {
        ...
        // data seeder = a method created to facilitate database seeding, which we override to add custom data
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Book>().HasData(
                new Book
                {
                    ...
                    Title = "Fight Club",
                    Description = "The book that seems impossible to live."
                },
                new Book
                {
                    ...
                    AuthorId = Guid.Parse("d28888e9-2ba9-473a-a40f-e38cb54f9b35"),
                    Title = "Submission",
                    Description = "  In the novel, recounting events from various points of view, Martin introduces the plot-lines of the noble houses of Westeros, the Wall, and the Targaryens."
                },
                new Book
                {
